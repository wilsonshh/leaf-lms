...
namespace WebApplication.ClaimsAuthorizationLibrary
{
    ...
    {
        private static Expression<Func<ClaimsPrincipal, bool>> DefaultPolicy = (icp) => false;
        private static Expression<Func<ClaimsPrincipal, bool>> AllowAccessForDefaultPagePolicy = (icp) => true;
        ...
        /// </summary>
        private static HasClaimDelegate HasClaim = delegate (ClaimsPrincipal p, string claimType, string claimValue)
          {
